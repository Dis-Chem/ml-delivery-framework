...
# ``example_aws_github_project/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-example-aws-github-project-experiment",
    label="MLflow experiment name",
)

# Unity Catalog registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev.test_project_schema_name.example-aws-github-project-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.test_project_schema_name.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.test_project_schema_name.trip_dropoff_features",
